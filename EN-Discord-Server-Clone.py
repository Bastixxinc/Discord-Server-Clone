...
BOT_TOKEN = ''  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN  # TOKEN
BOT_COMMAND_PREFIX = '!'
BOT_HELP_COMMAND = None
EMBED_COLOR = 0x000000
EMBED_FOOTER_TEXT = "Created by @Bastiix"
ARCHIVE_PREFIX = "B-Archive"
NON_DELETABLE_PREFIX = "Non-Deletable"
MSG_LOGGED_IN = 'Logged in as: {bot.user}'
MSG_ERROR_SERVER_NOT_FOUND = "Error: Server not found."
MSG_ALL_CHANNELS_MOVED = "All channels have been moved accordingly."
MSG_STRUCTURE_SAVED = "Structure of server '{guild.name}' was successfully saved."
MSG_ERROR_SAVING_STRUCTURE = "Error saving server structure: {e}"
CMD_HELP = 'help'
CMD_SAVE = 'save'
CMD_LOAD = 'load'
CMD_LIST = 'list'
CMD_CLEAR = 'clear'
MSG_HELP_SECTION = "Help Section"
MSG_HELP_DESCRIPTION = "Here is an overview of the available commands and how to use them."
MSG_HELP_COMMANDS = [("!save", "Saves the current server structure."),
                     ("!load [Number]", "Loads a saved server structure based on the numbering in !list."),
                     ("!list", "Lists all saved server structures."),
                     ("!clear", "Clears the B-Archive.")]
MSG_COMMAND_ERROR = "It seems you have used a command incorrectly. Here is some help:"
MSG_SAVING_STRUCTURE = "Saving server structure..."
MSG_STRUCTURE_LOADED = "Structure successfully loaded on server '{guild.name}'. {archive_message}"
MSG_ERROR_FILE_NOT_FOUND = "Error: File '{structure_file}' not found."
MSG_ERROR_INVALID_FORMAT = "Error: Invalid format in the structure file."
MSG_UNKNOWN_ERROR_LOADING = "Unknown error while loading the structure: {e}"
MSG_NO_SAVED_STRUCTURES = "No saved server structures found."
MSG_SAVED_STRUCTURES_LIST = "Saved server structures:\n"
MSG_INVALID_NUMBER = "Invalid number. Please use a valid number from the list."
MSG_LOADING_STRUCTURE = "Loading structure from file '{structure_file}'..."
MSG_ARCHIVE_CLEARED = "The B-Archive has been successfully cleared."
MSG_RATE_LIMIT_REACHED = "Rate limit reached, please try again later."
